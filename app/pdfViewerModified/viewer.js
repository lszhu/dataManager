...
function webViewerInitialized() {
  ...
  // chequeSys custom code -- start 定制代码 -- 开始

  // 针对本项目作出的特殊改变
    // 增加访问文件的分类
    var category = 'category' in params ? params.category : 'voucher';
    console.log('category: ' + category);
  // 增加前缀作为访问路径
    file = '/fetchPdf/' + category + '?file=' + file;
  //file = '/fetchPdf?file=' + file;
  // 用于调试
  console.log('params: %o', params);
  console.log('file: ' + file);
  // chequeSys custom code -- end 定制代码 -- 结束
